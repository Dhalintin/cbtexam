...
<div class="grid grid-cols-6 ">
  ...
  <div class="col-start-3 col-span-2 pr-5">
      <div class="border border-gradient-to-l pt-10 bg-white bg-gradient-to-r from-transparent to-green-100 rounded-2xl p-6 shadow-2xl dark:bg-gray-800 dark:border-gray-700">
          <div class="text-green-700 text-2xl px-1 font-bold">Student Register</div>
          <div class="pt-6">
            @if ($errors->any())
            ...
            <form action="{{ route('register') }}" method="POST">
              ...
              <div>
                ...
                <div><input type="text" name="fname" placeholder="Enter Last name" class="reg-form" required></div>

                <label for="lastname">Last Name</label>
                <div><input type="text" name="lname" placeholder="Enter First name" class="reg-form" required></div>
                ...
                <div><input type="number" name="role" value="0" class="reg-form" required hidden readonly></div>
